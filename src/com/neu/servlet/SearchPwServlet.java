...
import com.neu.service.PatiWardService;
...
public class SearchPwServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PatiWardService service=new PatiWardService();
		List<Map<String,String>> list=
				service.findByParams(params);
		HttpSession session=request.getSession();
		session.setAttribute("patiward", list);
		response.sendRedirect("selectpatiward.jsp");
